...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center mt-10 gap-1">
          <div className="flex flex-col gap-1 md:gap-3">
            ...
            <div class="text-secondary-text-light text-[17px] max-w-4xl leading-[30px] md:ml-3">
